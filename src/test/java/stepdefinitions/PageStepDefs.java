...
public class PageStepDefs {
    ...
    public void amazon_arama_kutusuna_nutella_yazip_aratir() {
        ...
        allPages.amazonPage().amazonAramaKutusu.sendKeys("Nutella" + Keys.ENTER);

    }
    @Then("arama sonuclarinin Nutella icerdigini test eder")
    public void arama_sonuclarinin_nutella_icerdigini_test_eder() {

        String actualAramaSonucu= allPages.amazonPage().aramaSonucuElementi.getText();
    ...
    public void amazonAramaKutusunaJavaYazipAratir() {
        allPages.amazonPage().amazonAramaKutusu.sendKeys("Java" + Keys.ENTER);
    }
    ...
    public void amazon_arama_kutusuna_samsung_yazip_aratir() {
        allPages.amazonPage().amazonAramaKutusu.sendKeys("Samsung" + Keys.ENTER);
    }
    ...
    public void amazonAramaKutusunaYazipAratir(String aranacakKelime) {
        ...
        allPages.amazonPage().amazonAramaKutusu.sendKeys(aranacakKelime + Keys.ENTER);
